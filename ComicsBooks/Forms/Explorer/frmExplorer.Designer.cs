namespace Bau.Applications.ComicsBooks.Forms.Explorer
{
	partial class frmExplorer
	{
		...
		this.udtFiles = new Bau.Controls.Files.FilesExplorer();
		...
		this.udtFiles.View = System.Windows.Forms.View.Details;
		this.udtFiles.FileSelected += new Bau.Controls.Files.ListFiles.FileSelectedHandler(this.udtFiles_FileSelected);
		this.udtFiles.FileDoubleClick += new Bau.Controls.Files.ListFiles.FileDoubleClickHandler(this.udtFiles_FileDoubleClick);
		this.udtFiles.PathChanged += new Bau.Controls.Files.ListFiles.PathChangedHandler(this.udtFiles_FileSelected);
		// 
		// frmExplorer
		// 
		...
		private Bau.Controls.Files.FilesExplorer udtFiles;
