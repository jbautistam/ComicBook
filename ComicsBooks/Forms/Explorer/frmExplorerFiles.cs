...
namespace Bau.Applications.ComicsBooks.Forms.Explorer
{
	...
	/// </summary>
	public partial class frmExplorerFiles : WeifenLuo.WinFormsUI.Docking.DockContent, IPluginDocument
	{
		public frmExplorerFiles()
		{	InitializeComponent();
		}
		...
		{ if (!string.IsNullOrEmpty(strFileName) && (System.IO.File.Exists(udtFiles.Path) || System.IO.Directory.Exists(udtFiles.Path)))
				{ // Abre el archivo
