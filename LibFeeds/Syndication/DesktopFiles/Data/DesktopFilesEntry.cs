...
namespace Bau.Libraries.LibFeeds.Syndication.DesktopFiles.Data
{
	...
	{ // Variables privadas
			private string strID, strLocalFileName;
		...
		/// </summary>
		public int CompareTo(DesktopFilesEntry objEntry)
		{ if (objEntry == null)
				return -1;
			else if (IsFolder && !objEntry.IsFolder)
				return -1;
			else
				return Text.CompareTo(objEntry.Text);
		}
